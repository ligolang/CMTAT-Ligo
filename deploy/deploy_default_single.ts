...
import singleAssetContract from "../compiled/cmtat/asset/cmtat_single_asset.impl.mligo.json";
...
async function main() {
  ...
  token_info.set("name", char2Bytes("CMTAT_TOKEN_0"));
  token_info.set("description", char2Bytes("My CMTA Token (single asset)"));
