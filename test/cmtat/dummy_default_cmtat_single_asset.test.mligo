...
{|{
  ...
  let minter_role : CMTAT_single_asset.AUTHORIZATIONS.role = MINTER in
  let burner_role : CMTAT_single_asset.AUTHORIZATIONS.role = BURNER in
  let profil_minter : CMTAT_single_asset.AUTHORIZATIONS.role set =  Set.add minter_role Set.empty in
  let profil_burner : CMTAT_single_asset.AUTHORIZATIONS.role set =  Set.add burner_role Set.empty in
...
let test_atomic_transfer_success =
  ...
  let transfer_requests = ([
    ({from_=owner1; txs=([{to_=owner2;token_id=0n;amount=2n};{to_=owner3;token_id=0n;amount=3n}] : CMTAT_single_asset.CmtatSingleAssetExtendable.TZIP12.atomic_trans list)});
    ({from_=owner2; txs=([{to_=owner3;token_id=0n;amount=2n};{to_=owner1;token_id=0n;amount=3n}] : CMTAT_single_asset.CmtatSingleAssetExtendable.TZIP12.atomic_trans list)});
  ] : CMTAT_single_asset.CmtatSingleAssetExtendable.TZIP12.transfer)
  in
...
let test_burn_success =
  ...
  // BURN (with burner)
  let () = Test.set_source op2 in  let burn_request = ({ recipient=owner1; token_id=0n; amount=2n } : CMTAT_single_asset.CmtatSingleAssetExtendable.burn_param) in
